...
submit.addEventListener("click", (e) => {
  ...
  <img alt="" src="assets/images/success icon 1.png"/> 
  </div>
...
<a href="/" style="border-radius: 3.125rem;background-color: #fff;outline: none;border: 1px solid var(--primary-black, #000); padding: 0.625rem 1.125rem; display: flex; align-items: center;">
